...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">剩余 xx 分钟 xx 秒</h3>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				<div class="form-item">
					<label>题目</label>
					<textarea readonly class="form-control textarea" id="questionname" rows="3"></textarea>
				</div>
				<div id="optionsArea" class="form-item">
					<label>选项</label>
					<textarea class="form-control textarea" rows="3" readonly></textarea>
				</div>
				<div id="answerArea" class="form-item">
					<label>答案</label>
				</div>
				<div id="yourAnswer" class="form-item" style="display: none;">
					<label>你的答案</label>
					<input readonly>
					<label style="color: red;">正确</label>
				</div>
				<div id="analysis" class="form-item" style="display: none;">
					<label>解析</label>
					<textarea class="form-control textarea" rows="2" placeholder="解析" readonly></textarea>
				</div>
				<div id="result" class="form-item" style="display: none;">
					<label>考试成绩</label>
					<input readonly>
				</div>
				<div class="form-btn">
					<button id="submitBtn" type="button" class="btn btn-warning btn-add">提交</button>
					<button id="nextBtn" type="button" class="btn btn-success btn-close">下一题</button>
				</div>
			</form>
		</div>
	</div>
	...
	<%@include file = "../../static/crossBtnControl.js" %>
		...
		function setTimeMsg() {
			if (time > 0) {
				...
				$('.breadcrumb-title').html(str);
			} else {
				$('.breadcrumb-title').html('考试结束');
			}
		}
		//提交当前题目答案
