...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">模拟考试列表管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>模拟考试列表管理</span></li>
				<li class="breadcrumb-item-two"><span>模拟考试列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			<div class="center-form">
				<div class="form-item">
					<label>模拟考试</label>
					<input type="text" id="nameSearch" class="form-control form-control-sm" placeholder="模拟考试名称" aria-controls="tableId">
				</div>
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th onclick="sort('name')">模拟考试<i id="nameIcon"
