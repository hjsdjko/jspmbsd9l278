...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑模拟考试表</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>编辑模拟考试表</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>模拟考试名称</label>
					<input name="name" id="name" name="name" class="form-control" placeholder="请输入模拟考试名称">
				</div>
				<div class="form-item">
					<label>考试时长(分钟)</label>
					<input name="time" id="time" name="time" class="form-control" placeholder="请输入考试时长(分钟)">
				</div>
				<div class="form-item">
					<label>模拟考试状态</label>
					<select id="statusSelect" name="status" class="form-control">
							<option value="">请选择模拟考试状态</option>
