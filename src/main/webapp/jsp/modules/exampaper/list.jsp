...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">模拟考试表管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>模拟考试表管理</span></li>
				<li class="breadcrumb-item-two"><span>模拟考试表列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="center-form">
				<div class="form-item">
					<label>模拟考试名称</label>
					<input type="text" id="nameSearch" class="form-control form-control-sm" placeholder="请输入模拟考试名称" aria-controls="tableId">
				</div>
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th onclick="sort('name')">模拟考试名称<i id="nameIcon" class="fa fa-sort"></i></th>
						<th onclick="sort('time')">考试时长(分钟)<i id="timeIcon" class="fa fa-sort"></i></th>
						<th onclick="sort('status')">模拟考试状态<i id="statusIcon" class="fa fa-sort"></i></th>
						<th>操作</th>
					</tr>
				</thead>
				<tbody></tbody>
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
        ...
        function pay(item){
			...
			window.sessionStorage.setItem('tableName',"exampaper");
