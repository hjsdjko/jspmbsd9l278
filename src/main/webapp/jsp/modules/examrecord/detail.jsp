...
<body>
	<div id="main-container">
		...
		<div id="center-container">
			<div class="center-form">
				<div class="form-item">
					...
					<input type="text" id="papernameSearch"
						class="form-control form-control-sm" placeholder="模拟考试名称"
			...
			<div class="btns">
				<button onclick="backList()" type="button" class="btn btn-danger btn-del"><span>返回</span></button>
			</div>
				...
				<thead>
					<tr>
						...
						<th onclick="sort('papername')">模拟考试<i id="papernameIcon"
							class="fa fa-sort"></i></th>
						<th onclick="sort('questionname')">题目名称<i
