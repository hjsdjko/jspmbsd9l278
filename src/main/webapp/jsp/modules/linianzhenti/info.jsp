...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">查看历年真题</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>查看历年真题</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item-file">
					...
					<button class="btn-upload btn-file" id="liniantimu">点击下载</button>
				</div>
	...
	<script>
		...
		function setDownloadBtn(){
			var liniantimuUrl = "download('" + ruleForm.liniantimu + "')";
			$("#liniantimu").attr("onclick",liniantimuUrl);
		}			
		//设置音视频播放链接
