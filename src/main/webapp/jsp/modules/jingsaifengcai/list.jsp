...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">竞赛风采管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>竞赛风采列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th onclick="sort('jingsaichengji')">竞赛成绩<i id="jingsaichengjiIcon" class="fa fa-sort"></i></th>
						<th onclick="sort('huojiangmingci')">获奖名次<i id="huojiangmingciIcon" class="fa fa-sort"></i></th>
						<th>评语</th>
						<th>获奖图片</th>
						<th onclick="sort('huojiangshijian')">获奖时间<i id="huojiangshijianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var jingsaichengjiCell  = document.createElement('td');

						 jingsaichengjiCell.innerHTML = item.jingsaichengji;

			row.appendChild(jingsaichengjiCell);
			var huojiangmingciCell  = document.createElement('td');

						 huojiangmingciCell.innerHTML = item.huojiangmingci;

			row.appendChild(huojiangmingciCell);
			...
			var jingsaizuopinCell  = document.createElement('td');

			            var jingsaizuopinImg = document.createElement('img');
            jingsaizuopinImg.setAttribute('src',item.jingsaizuopin?(baseUrl+item.jingsaizuopin.split(",")[0]):'');
			jingsaizuopinImg.setAttribute('height',100);
			jingsaizuopinImg.setAttribute('width',100);
			jingsaizuopinCell.appendChild(jingsaizuopinImg);


			row.appendChild(jingsaizuopinCell);
			var huojiangshijianCell  = document.createElement('td');

						  huojiangshijianCell.innerHTML = item.huojiangshijian;


			row.appendChild(huojiangshijianCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("jingsaifengcai/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"jingsaifengcai");
