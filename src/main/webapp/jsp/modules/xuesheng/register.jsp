...
<body>
	...
	<div class="content">
			<form id="registerForm" action="" method="post">
				...
				<div class="list-item">
					<input  id="xuehao" name="xuehao"  placeholder="请输入学号" class="form-control-i">
				</div>
				<div class="list-item">
					<input  id="xueshengxingming" name="xueshengxingming"  placeholder="请输入学生姓名" class="form-control-i">
				</div>
				<div class="list-item">
