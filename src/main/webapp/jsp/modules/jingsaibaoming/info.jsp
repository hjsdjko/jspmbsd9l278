...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">查看竞赛报名</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>查看竞赛报名</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item-file">
					...
					<button class="btn-upload btn-file" id="baomingziliao">点击下载</button>
				</div>
				<div class="form-item">
					<label>报名人数</label>
	...
	<script>
		...
		function setDownloadBtn(){
			var baomingziliaoUrl = "download('" + ruleForm.baomingziliao + "')";
			$("#baomingziliao").attr("onclick",baomingziliaoUrl);
		}			
		//设置音视频播放链接
