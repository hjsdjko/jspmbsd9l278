...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">竞赛报名管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>竞赛报名列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th>报名资料</th>
						<th onclick="sort('yibaorenshu')">报名人数<i id="yibaorenshuIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var baomingziliaoCell  = document.createElement('td');

						  var baomingziliaoFile = document.createElement('button');
			  baomingziliaoFile.setAttribute('class','btn-table')
			  baomingziliaoFile.innerHTML = '下载';
			  var baomingziliaoFileAttr = "download('" +baseUrl+ item.baomingziliao + "')"
			  baomingziliaoFile.setAttribute('onclick',baomingziliaoFileAttr);
        	          baomingziliaoCell.appendChild(baomingziliaoFile);


			row.appendChild(baomingziliaoCell);
			...
			var crossBtn0 = document.createElement('button');
            		crossBtn0.innerHTML = "发布"
			crossBtn0.setAttribute("type","button");
			crossBtn0.setAttribute("class","btn btn-primary btn-sm");
			crossBtn0.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'bisaifengcai','是','[1]','请勿重复提交')");
			if(crossBtnControl('发布') == true){
		...
		function sh(){
			...
			httpJson("jingsaibaoming/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("jingsaibaoming/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"jingsaibaoming");
