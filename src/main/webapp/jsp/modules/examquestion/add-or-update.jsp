...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑题目</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>编辑题目</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
					...
					<div class="form-item">
						<label>模拟考试</label>
						<select id="papernameSelect" name="papername" onchange="setPaperId()" class="form-control"></select>
					</div>
					<div class="form-item">
						<label>题目</label>
						<textarea placeholder="题目" class="form-control textarea" id="questionname" name="questionname" rows="3"></textarea>
					</div>
					<div class="form-item">
						<label>类型</label> 
					...
					<div id="optionsParent" class="form-item" style="display: none;">
						<label>选项</label>
						<br>
					...
					<div id="answerParent" class="form-item">
						<label>答案</label>
						<input id="answer" name="answer" class="form-control" placeholder="答案">
					</div>
					<div class="form-item">
						<label>分数</label> <input id="score" name="score" class="form-control" placeholder="分数">
					</div>
					<div class="form-item">
						<label>分析</label>
						<textarea placeholder="分析" class="form-control textarea" id="analysis" name="analysis" rows="3"></textarea>
					</div>
					<div class="form-item">
						<label>排序</label>
						<input id="sequence" name="sequence" class="form-control" placeholder="排序">
					</div>
					<div class="form-btn">
