...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑学校</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>编辑学校</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>学校</label>
					<input name="xuexiao" id="xuexiao" name="xuexiao" class="form-control" placeholder="请输入学校">
				</div>
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.xuexiao != null && res.data.xuexiao != ''){
						...
						$("#xuexiao").attr('readonly','readonly');
					}
				}
			});  
            }
