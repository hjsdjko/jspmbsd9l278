...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">学校管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>学校管理</span></li>
				<li class="breadcrumb-item-two"><span>学校列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="center-form">
				<div class="form-item">
					<label>学校</label>
					<input type="text" id="xuexiaoSearch" class="form-control form-control-sm" placeholder="请输入学校" aria-controls="tableId">
				</div>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#xuexiaoSearch').val() != null && $('#xuexiaoSearch').val() != ''){
				searchForm.xuexiao ="%" +  $('#xuexiaoSearch').val() + "%";
			}
