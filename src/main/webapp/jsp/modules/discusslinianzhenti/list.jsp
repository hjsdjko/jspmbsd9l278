...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">历年真题评论表管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>历年真题评论表管理</span></li>
				<li class="breadcrumb-item-two"><span>历年真题评论表列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
	...
	<script>
		...
		var tableName = "discusslinianzhenti";
		var pageType = "list";
	  	var searchForm = { key: ""};
		var pageIndex = 1;
		var pageSize = 10;
        ...
        function getDataList() {
			http("discusslinianzhenti/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("discusslinianzhenti/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function getSum(colName){
		http("discusslinianzhenti"+colName,"GET",{
			tableName: "discusslinianzhenti",
			columnName: colName
		},(res)=>{
			if(res.code == 0){
				return res.data.sum;
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"discusslinianzhenti");
        ...
        function pay(item){
			...
			window.sessionStorage.setItem('tableName',"discusslinianzhenti");
