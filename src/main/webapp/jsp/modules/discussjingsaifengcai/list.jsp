...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">竞赛风采评论表管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>竞赛风采评论表列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th>评论内容</th>
						<th onclick="sort('score')">评分<i id="scoreIcon" class="fa fa-sort"></i></th>
						<th>回复内容</th>
						<th>操作</th>
					</tr>
				</thead>
	...
	<script>
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("discussjingsaifengcai/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"discussjingsaifengcai");
        ...
        function pay(item){
			...
			window.sessionStorage.setItem('tableName',"discussjingsaifengcai");
