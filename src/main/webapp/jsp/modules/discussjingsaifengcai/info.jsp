...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">查看竞赛风采评论表</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>查看竞赛风采评论表</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					...
					<input id="score" name="score" class="form-control" v-model="ruleForm.score" readonly>
				</div>
