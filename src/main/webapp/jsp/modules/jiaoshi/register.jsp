...
<body>
	...
	<div class="content">
			<form id="registerForm" action="" method="post">
				...
				<div class="list-item">
					<input  id="jiaoshigonghao" name="jiaoshigonghao"  placeholder="请输入教师工号" class="form-control-i">
				</div>
				<div class="list-item">
				...
				<div class="list-item">
					<input  id="jiaoshixingming" name="jiaoshixingming"  placeholder="请输入教师姓名" class="form-control-i">
				</div>
				<div class="list-item">
					<input  id="jiaoshidianhua" name="jiaoshidianhua"  placeholder="请输入教师电话" class="form-control-i">
				</div>
