...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑教师</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>教师管理</span></li>
				<li class="breadcrumb-item-two"><span>编辑教师</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>教师工号</label>
					<input name="jiaoshigonghao" readonly id="jiaoshigonghao" name="jiaoshigonghao" class="form-control" placeholder="请输入教师工号">
				</div>
				...
				<div class="form-item">
					<label>教师电话</label>
					<input name="jiaoshidianhua"  id="jiaoshidianhua" name="jiaoshidianhua" class="form-control" placeholder="请输入教师电话">
				</div>
