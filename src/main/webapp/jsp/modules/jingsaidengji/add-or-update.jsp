...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑竞赛等级</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>竞赛等级管理</span></li>
				<li class="breadcrumb-item-two"><span>编辑竞赛等级</span></li>
			</ol>
		</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "jingsaidengji/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("jingsaidengji/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("jingsaidengji/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("jingsaidengji/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("jingsaidengji"+colName,"GET",{
				tableName: "jingsaidengji",
				columnName: colName
			},(res)=>{
				if(res.code == 0){
