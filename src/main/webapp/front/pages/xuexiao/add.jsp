			...
			<div class="data-add-container" :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"rgba(255,255,255,.3)"}'>
				<form class="layui-form layui-form-pane add" lay-filter="myForm">
					<div :style='{"padding":"10px","margin":"0 0 10px 0","borderColor":"#c6ecc6","alignItems":"center","borderWidth":"4px","background":"#fff","display":"flex","borderStyle":"solid"}' class="layui-form-item">
						...
						<input :style='{"padding":"0 10px","margin":"0","borderColor":"#9dcde9","color":"#333","outline":"none","borderRadius":"4px","borderWidth":"0 0 0px","background":"#eff8ee","width":"360px","fontSize":"14px","lineHeight":"40px","borderStyle":"dotted","height":"40px"}' v-model="detail.xuexiao" type="text" :readonly="ro.xuexiao" name="xuexiao" id="xuexiao" autocomplete="off" class="layui-input">
					</div>
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('xuexiao/list', 'get', {
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 提交数据
                                            http.requestJson('xuexiao' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
