	...
	<body>
		<div id="app" class="container">
			...
			<div class="detail-content" v-if="!isEndFlag">
				...
				<div v-if="(ruleForm.type==0)&&!isSubmitFlag" class="item-content" style="border-top:1px solid #eeeeee">
					<span class="label">选择答案：</span>
					<span class="content">
						<el-select v-model="answer">
							<el-option :label="item.code+'.'+item.text" :value="item.code" v-for="(item,index) in options" v-bind:key="index"></el-option>
						</el-select>
					</span>
				</div>
				<div v-if="(ruleForm.type==2)&&!isSubmitFlag" class="item-content" style="border-top:1px solid #eeeeee">
					<span class="label">选择答案：</span>
					<span class="content">
						<el-select v-model="answer">
				...
				<div v-if="isSubmitFlag" class="item-content" style="color:#888888">
                                        <span v-if="answer==this.ruleForm.answer" class="label" style="color:green;margin-right:20px">正确</span>
                                        <span v-if="answer!=this.ruleForm.answer" class="label" style="color:red;margin-right:20px">错误</span>
