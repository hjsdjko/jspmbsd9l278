			...
			<div class="recommend" :style='{"width":"100%","padding":"10px 7%","margin":"0px auto","position":"relative","background":"none"}'>
				...
				<form class="layui-form filter" :style='{"padding":"30px 10px 0","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto"}'>
					...
					<div :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}' class="item-list">
						<div class="lable" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px"}'>学号</div>
						<input type="text" :style='{"border":"1px solid #bdefb6","padding":"0 10px","boxShadow":"inset 0px 0px 32px 0px #c5f1c0","margin":"0","outline":"none","color":"#333","borderRadius":"4px","width":"140px","fontSize":"14px","lineHeight":"40px","height":"40px"}' name="xuehao" id="xuehao" placeholder="学号" autocomplete="off" class="layui-input">
					</div>
					<div :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}' class="item-list">
				...
				<div :style='{"margin":"20px 0 10px","background":"none"}' class="lists">
					...
					<div :style='{"padding":"0px","margin":"30px 0 0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}' class="list list-1">
						<div :style='{"border":"0px solid #bdefb6","padding":"10px","boxShadow":"0px 2px 6px #e6e6e6","margin":"0 0 20px","borderRadius":"8px","flexWrap":"wrap","background":"#fff","display":"flex","width":"23.5%","position":"relative","justifyContent":"space-between","height":"auto"}' @click="jump('../xuesheng/detail.jsp?id='+item.id)" v-for="(item,index) in dataList" :key="index" class="list-item animation-box">
							<img :style='{"cursor":"pointer","border":"0px solid #bdefb6","padding":"0px","margin":"0 0 8px","objectFit":"contain","background":"#fff","display":"block","width":"100%","height":"320px"}' :src="item.touxiang?baseurl+item.touxiang.split(',')[0]:''">
							...
							<div :style='{"cursor":"pointer","padding":"4px 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#249940","textAlign":"center","width":"100%","lineHeight":"24px","fontSize":"16px","textOverflow":"ellipsis"}' class="name">学生姓名:{{item.xueshengxingming}}</div>
							<div :style='{"cursor":"pointer","padding":"4px 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#249940","textAlign":"center","width":"100%","lineHeight":"24px","fontSize":"16px","textOverflow":"ellipsis"}' class="name">学校:{{item.xuexiao}}</div>
							<div :style='{"cursor":"pointer","padding":"4px 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#249940","textAlign":"center","width":"100%","lineHeight":"24px","fontSize":"16px","textOverflow":"ellipsis"}' class="name">专业:{{item.zhuanye}}</div>
						</div>
					</div>
			...
			layui.use(['form', 'layer', 'element', 'carousel', 'laypage', 'http', 'jquery','laydate', 'slider'], function() {
				...
				http.request('config/list', 'get', {
        			...
        			http.request(`option/xuexiao/xuexiao`,'get',{},(res)=>{
                			vue.xuexiaoOptions = res.data
							vue.$nextTick(() => {form.render()})
        			});
        			http.request(`option/zhuanye/zhuanye`,'get',{},(res)=>{
                			vue.zhuanyeOptions = res.data
							vue.$nextTick(() => {form.render()})
        			});
