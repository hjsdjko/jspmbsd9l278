				...
				<div :style='{"padding":"10px 0 0px 0px","boxShadow":"0px 0px 4px #eee","borderColor":"#ddd","overflow":"hidden","borderRadius":"0px","flexWrap":"wrap","background":"rgba(255,255,255,1)","borderWidth":"1px","display":"flex","position":"relative","borderStyle":"solid","justifyContent":"space-between"}'>
					...
					<div :style='{"minHeight":"500px","width":"48%","padding":"10px 10px 10px 20px","margin":"0","background":"none","order":"1"}'>
						<div :style='{"padding":"10px 20px","boxShadow":"inset 0px 0px 0px 0px #93c8e7","margin":"0 0 10px 0","borderColor":"#c6ecc6","alignItems":"center","borderRadius":"20px","background":"linear-gradient(320deg, rgba(204,204,204,.0) 0%, rgba(255,255,255,.9) 80%, rgba(204,204,204,.0) 100%)","borderWidth":"4px","display":"flex","borderStyle":"solid","justifyContent":"space-between"}'>
							...
							<div v-if='storeupFlag' :style='{"cursor":"pointer","padding":"6px 10px","borderRadius":"20px","background":"#fff"}' @click="storeUp()">
						...
						<div :style='{"padding":"0px","boxShadow":"inset 0px 0px 0px 0px #ddd","margin":"0 0 10px 0","borderColor":"#c6ecc6","background":"linear-gradient(320deg, rgba(204,204,204,.0) 0%, rgba(255,255,255,.9) 80%, rgba(204,204,204,.0) 100%)","borderWidth":"0px 0px 1px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#666","textAlign":"right","background":"linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>竞赛简介：</div>
						...
						<div :style='{"padding":"0px","boxShadow":"inset 0px 0px 0px 0px #ddd","margin":"0 0 10px 0","borderColor":"#c6ecc6","background":"linear-gradient(320deg, rgba(204,204,204,.0) 0%, rgba(255,255,255,.9) 80%, rgba(204,204,204,.0) 100%)","borderWidth":"0px 0px 1px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#666","textAlign":"right","background":"linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>已报人数：</div>
							<div  :style='{"minHeight":"40px","padding":"2px 10px 0","color":"#555","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5","width":"100%","fontSize":"14px","lineHeight":"24px"}' class="desc">
								{{detail.yibaorenshu}}
							</div>
						</div>
						...
						<div :style='{"padding":"0px","boxShadow":"inset 0px 0px 0px 0px #ddd","margin":"0 0 10px 0","borderColor":"#c6ecc6","background":"linear-gradient(320deg, rgba(204,204,204,.0) 0%, rgba(255,255,255,.9) 80%, rgba(204,204,204,.0) 100%)","borderWidth":"0px 0px 1px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#666","textAlign":"right","background":"linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>截止时间：</div>
							<div  :style='{"minHeight":"40px","padding":"2px 10px 0","color":"#555","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5","width":"100%","fontSize":"14px","lineHeight":"24px"}' class="desc">
								{{detail.jiezhishijian}}
							</div>
						</div>
						<div :style='{"padding":"0px","boxShadow":"inset 0px 0px 0px 0px #ddd","margin":"0 0 10px 0","borderColor":"#c6ecc6","background":"linear-gradient(320deg, rgba(204,204,204,.0) 0%, rgba(255,255,255,.9) 80%, rgba(204,204,204,.0) 100%)","borderWidth":"0px 0px 1px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#666","textAlign":"right","background":"linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>竞赛地址：</div>
							<div  :style='{"minHeight":"40px","padding":"2px 10px 0","color":"#555","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5","width":"100%","fontSize":"14px","lineHeight":"24px"}' class="desc">
								{{detail.jingsaidizhi}}
							</div>
						</div>
						<div :style='{"padding":"0px","boxShadow":"inset 0px 0px 0px 0px #ddd","margin":"0 0 10px 0","borderColor":"#c6ecc6","background":"linear-gradient(320deg, rgba(204,204,204,.0) 0%, rgba(255,255,255,.9) 80%, rgba(204,204,204,.0) 100%)","borderWidth":"0px 0px 1px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#666","textAlign":"right","background":"linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>竞赛规则：</div>
							<div  :style='{"minHeight":"40px","padding":"2px 10px 0","color":"#555","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5","width":"100%","fontSize":"14px","lineHeight":"24px"}' class="desc">
								{{detail.jingsaiguize}}
							</div>
						</div>
						<div :style='{"padding":"0px","boxShadow":"inset 0px 0px 0px 0px #ddd","margin":"0 0 10px 0","borderColor":"#c6ecc6","background":"linear-gradient(320deg, rgba(204,204,204,.0) 0%, rgba(255,255,255,.9) 80%, rgba(204,204,204,.0) 100%)","borderWidth":"0px 0px 1px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#666","textAlign":"right","background":"linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>发布日期：</div>
							<div  :style='{"minHeight":"40px","padding":"2px 10px 0","color":"#555","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5","width":"100%","fontSize":"14px","lineHeight":"24px"}' class="desc">
								{{detail.faburiqi}}
							</div>
						</div>
						...
						<div class="detail-item" :style='{"padding":"10px 0","flexWrap":"wrap","background":"none","display":"flex"}'>
							...
							<button :style='{"border":"1px solid #b8d7f2","cursor":"pointer","padding":"0 10px","margin":"0 5px 0px 0","outline":"none","color":"#218eee","borderRadius":"0px","background":"#e1f0fe","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="isAuth('jingsaixinxi','报名')" @click="onAcrossTap('jingsaibaoming','[1]','请勿重复报名')" type="button" class="layui-btn">
								报名
							</button>
