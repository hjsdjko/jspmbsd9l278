				...
				<div :style='{"width":"calc(100% - 0px)","padding":"0px","margin":"20px 0 0","background":"none"}' class="right-container">
					<form :style='{"padding":"20px 20px","boxShadow":"0px 0px 4px #eee","borderColor":"#ddd","flexWrap":"wrap","background":"#fff","borderWidth":"1px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"space-between","height":"auto"}' class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item"  :style='{"padding":"10px","margin":"0 0 20px 0","borderColor":"#c6ecc6","alignItems":"center","background":"#fff","borderWidth":"4px","display":"flex","width":"48%","borderStyle":"solid"}'>
							<label :style='{"width":"150px","padding":"0 15px","lineHeight":"40px","textAlign":"right"}' class="layui-form-label">教师工号</label>
							<input :style='{"padding":"0 10px","margin":"0","borderColor":"#bfecb9","color":"#333","outline":"none","borderRadius":"0px","borderWidth":"1px","background":"#eff8ee","width":"auto","fontSize":"14px","lineHeight":"40px","borderStyle":"solid","height":"40px"}' type="text" readonly="readonly" name="jiaoshigonghao" name="jiaoshigonghao" id="jiaoshigonghao" placeholder="教师工号" autocomplete="off" class="layui-input">
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","margin":"0 0 20px 0","borderColor":"#c6ecc6","alignItems":"center","background":"#fff","borderWidth":"4px","display":"flex","width":"48%","borderStyle":"solid"}'>
						...
						<div class="layui-form-item"  :style='{"padding":"10px","margin":"0 0 20px 0","borderColor":"#c6ecc6","alignItems":"center","background":"#fff","borderWidth":"4px","display":"flex","width":"48%","borderStyle":"solid"}'>
							<label :style='{"width":"150px","padding":"0 15px","lineHeight":"40px","textAlign":"right"}' class="layui-form-label">教师姓名</label>
							<input :style='{"padding":"0 10px","margin":"0","borderColor":"#bfecb9","color":"#333","outline":"none","borderRadius":"0px","borderWidth":"1px","background":"#eff8ee","width":"auto","fontSize":"14px","lineHeight":"40px","borderStyle":"solid","height":"40px"}' type="text"  name="jiaoshixingming" name="jiaoshixingming" id="jiaoshixingming" placeholder="教师姓名" autocomplete="off" class="layui-input">
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","margin":"0 0 20px 0","borderColor":"#c6ecc6","alignItems":"center","background":"#fff","borderWidth":"4px","display":"flex","width":"48%","borderStyle":"solid"}'>
							<label :style='{"width":"150px","padding":"0 15px","lineHeight":"40px","textAlign":"right"}' class="layui-form-label">教师电话</label>
							<input :style='{"padding":"0 10px","margin":"0","borderColor":"#bfecb9","color":"#333","outline":"none","borderRadius":"0px","borderWidth":"1px","background":"#eff8ee","width":"auto","fontSize":"14px","lineHeight":"40px","borderStyle":"solid","height":"40px"}' type="text"  name="jiaoshidianhua" name="jiaoshidianhua" id="jiaoshidianhua" placeholder="教师电话" autocomplete="off" class="layui-input">
						</div>
