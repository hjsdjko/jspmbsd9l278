	...
	<body>
		<div id="register" class="register" :style='{"minHeight":"100vh","width":"100%","alignItems":"center","background":"url(http://codegen.caihongy.cn/20230104/149cce5901d247838e12d10d26caa0e4.jpg) no-repeat center top / 100% 100%","justifyContent":"center","display":"flex"}'>
			<form id="registerForm" class="layui-form login-form" :style='{"padding":"20px 120px","boxShadow":"0 0px 0px rgba(0, 0, 0, .1)","margin":"0","borderRadius":"30px","flexWrap":"wrap","background":"rgba(255,255,255,.9)","display":"flex","width":"680px","justifyContent":"center","height":"auto"}' lay-filter="myForm">
				...
				<div v-if="true" :style='{"boxShadow":"inset 0px 0px 32px 0px #c5f1c0","margin":"0 auto 20px","borderColor":"#bdefb6","color":"#5bb450","textAlign":"center","background":"none","borderWidth":"1px 4px","width":"100%","lineHeight":"44px","fontSize":"16px","borderStyle":"solid","textShadow":"0px 0px 0px rgba(64, 158, 255, .5)"}'>教师注册</p></div>
			

				<div :style='{"width":"100%","padding":"0","margin":"0 auto 10px","position":"relative","height":"auto"}' class="form-item">
					<div v-if="true" :style='{"padding":"0 4px","color":"#333","left":"-130px","textAlign":"right","width":"130px","lineHeight":"44px","fontSize":"14px","position":"absolute"}'>教师工号：</div>
					<input :style='{"padding":"0 10px","boxShadow":"inset 0px 0px 12px 0px #c5f1c0","outline":"none","borderColor":"#bdefb6","color":"#333","borderRadius":"8px","borderWidth":"1px","width":"100%","fontSize":"14px","borderStyle":"solid","height":"40px"}' type="text"   id="jiaoshigonghao" name="jiaoshigonghao" placeholder="请输入教师工号" autocomplete="off" class="layui-input">
				</div>
                <div :style='{"width":"100%","padding":"0","margin":"0 auto 10px","position":"relative","height":"auto"}' class="form-item">
				...
				<div :style='{"width":"100%","padding":"0","margin":"0 auto 10px","position":"relative","height":"auto"}' class="form-item">
					<div v-if="true" :style='{"padding":"0 4px","color":"#333","left":"-130px","textAlign":"right","width":"130px","lineHeight":"44px","fontSize":"14px","position":"absolute"}'>教师姓名：</div>
					<input :style='{"padding":"0 10px","boxShadow":"inset 0px 0px 12px 0px #c5f1c0","outline":"none","borderColor":"#bdefb6","color":"#333","borderRadius":"8px","borderWidth":"1px","width":"100%","fontSize":"14px","borderStyle":"solid","height":"40px"}' type="text"   id="jiaoshixingming" name="jiaoshixingming" placeholder="请输入教师姓名" autocomplete="off" class="layui-input">
				</div>
				<div :style='{"width":"100%","padding":"0","margin":"0 auto 10px","position":"relative","height":"auto"}' class="form-item">
					<div v-if="true" :style='{"padding":"0 4px","color":"#333","left":"-130px","textAlign":"right","width":"130px","lineHeight":"44px","fontSize":"14px","position":"absolute"}'>教师电话：</div>
					<input :style='{"padding":"0 10px","boxShadow":"inset 0px 0px 12px 0px #c5f1c0","outline":"none","borderColor":"#bdefb6","color":"#333","borderRadius":"8px","borderWidth":"1px","width":"100%","fontSize":"14px","borderStyle":"solid","height":"40px"}' type="text"   id="jiaoshidianhua" name="jiaoshidianhua" placeholder="请输入教师电话" autocomplete="off" class="layui-input">
				</div>
        ...
        <script src="../../js/xm-select.js"></script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function() {
				...
				form.on('submit(register)', function(data) {
                    ...
                    if(!isMobile(data.jiaoshidianhua)){
                        layer.msg('教师电话应输入手机格式', {
							time: 2000,
							icon: 5
						});
                        return false
